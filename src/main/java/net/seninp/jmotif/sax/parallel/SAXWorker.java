...
public class SAXWorker implements Callable<HashMap<Integer, char[]>> {
    ...
    public SAXWorker(long id, double[] data, int intervalStart, int intervalEnd, int windowSize,
        ...
        LOGGER.debug("sax worker instance id {}, data {}, window {}, paa  {}, alphabet {}, nr {}, threshold: {}, start: {}, end: {}",
                this.id, this.ts.length, this.saxWindowSize, this.saxPAASize, this.saxAlphabetSize, this.numerosityReductionStrategy,
                normalizationThreshold, this.intervalStart, this.intervalEnd);
